...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-wsa9k4v_goql%t8rn@q4*5flo+xnnxa%8!^p2g(4g-=py==ur)')
...
# Database Configuration (SQLite3 default, customizable via DATABASE_URL)
DATABASES = {
    'default': {
